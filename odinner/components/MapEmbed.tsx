...
export default function MapEmbed() {
  ...
  return (
    <button
      ...
      className="flex h-full min-h-[280px] w-full flex-col items-center justify-center gap-3 bg-coal-soft p-6 text-center transition-colors hover:bg-coal-card"
    >
      <PinIcon className="h-8 w-8 text-red" />

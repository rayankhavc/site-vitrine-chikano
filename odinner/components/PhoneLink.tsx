  ...
  return (
    <>
      ...
      {copied ? (
        <span
          role="status"
          className="fixed inset-x-0 bottom-6 z-[70] mx-auto flex w-max items-center gap-2 rounded-full bg-red px-5 py-2.5 text-sm font-bold text-bone shadow-plate"
        >
